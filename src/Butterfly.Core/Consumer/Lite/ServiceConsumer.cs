...
{
    internal class ServiceConsumer : IConsumer
    {
        ...
        public ServiceConsumer(ISource<IEnumerable<Span>> streamingSource, IServiceStorage serviceStorage, ILogger<SpanConsumer> logger)
        {
            _logger = logger;
